...
##save plot
tiff(filename = "plots/Drivers_BodySize_ALL.tiff", width = 9, height = 9, units = 'in', res = 600, compression = 'lzw')
...
layout(mat = matrix(c(1:20), 
                        ...
                        ncol = 5),
       heights = c(0.6,2,2,2),
       widths = c(0.7,0.8,2,2,2))

par(mar=c(4,0.4,0.4,0.8))
#empty plots for where the labels will go
plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '')
plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '')
title(ylab=expression(italic("C. pilularius")), line=-1.4,cex.lab=1.5)
plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '')
title(ylab=expression(italic('O. nuchicornis')), line=-1.4,cex.lab=1.5)
title(ylab="                                F", line=-1.4,cex.lab=1.5)
plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '')
title(ylab=expression(italic('O. nuchicornis')), line=-1.4,cex.lab=1.5)
title(ylab="                                M", line=-1.4,cex.lab=1.5)
...
plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '')
plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '')
title(xlab="Contemporary", line=1,cex.lab=1.5)
...
axis(2, at=yy, lwd = 0, lwd.ticks = 0, labels=c("Temperature", "Plant quality", "Browser dung", "Grazer dung", "PD dung", "Intraspecific density"), las=1,cex.axis=1.5)
#title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("D"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
...
axis(2, at=yy, lwd = 0, lwd.ticks = 0, labels=c("Temperature", "Plant quality", "Browser dung", "Grazer dung", "PD dung", "Intraspecific density"), las=1,cex.axis=1.5)
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("G"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
...
###############################
plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '')
title(xlab="1 mo. prior", line=1,cex.lab=1.5)

# attach data
drivEst <- read.csv("outputs/DriverModelOutputs/BodySize_1mpConditions.csv")
...
est <- sub$Estimate[2:7]
yy <- c(1:6)
plot(yy ~ est, ylab="",xlab="", yaxt="n", las=1, type="n",xlim=c(min(subQ),max(subQ)), ylim=c(0.8,6.8),cex=2, bty="n")
segments(x0=0,y0=0,x1=0,y1=6.5,lty=2, lwd=2,col="grey60")
#axis(2, at=yy, lwd = 0, lwd.ticks = 0, labels=c("Temperature", "Plant quality", "Browser dung", "Grazer dung", "PD dung", "Intraspecific density"), las=1,cex.axis=1.5)
#title(xlab="Estimate", line=2.4,cex.lab=1.3)
...
segments(x0=0,y0=0,x1=0,y1=6.5,lty=2, lwd=2,col="grey60")
#title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("E"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
...
segments(x0=0,y0=0,x1=0,y1=6.5,lty=2, lwd=2,col="grey60")
title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("H"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
...
###############################
plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '')
title(xlab="2 mo. prior", line=1,cex.lab=1.5)

# attach data
drivEst <- read.csv("outputs/DriverModelOutputs/BodySize_2mpConditions.csv")
...
#axis(2, at=yy, lwd = 0, lwd.ticks = 0, labels=c("Temperature", "Plant quality", "Browser dung", "Grazer dung", "PD dung", "Intraspecific density"), las=1,cex.axis=1.5)
#title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("C"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
...
segments(x0=0,y0=0,x1=0,y1=6.5,lty=2, lwd=2,col="grey60")
#title(xlab="Estimate", line=2.4,cex.lab=1.3)
legend("topleft", legend=("F"), bty="n", cex=1.3)
mm <- cbind(yy,est)
mm_neg <- as.data.frame(mm[ which(est < 0),])
mm_pos <- as.data.frame(mm[ which(est > 0),])
#points(yy ~ est, pch="l",cex=2.2,col="white")
